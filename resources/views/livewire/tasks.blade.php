        ...
        <div class="card w-100">
            <div class="d-flex flex-column">
                ...
                <div class="m-3 text-center text-md-start" id="control-buttons">
                    <button style="border: none" class="btn" wire:click="set_filter({{ 0 }})">Todos</button>
                    <button style="border: none" class="btn"
                        wire:click="set_filter({{ 1 }})">Concluídos</button>
                    <button style="border: none" class="btn" wire:click="set_filter({{ 2 }})">Não
                        Concluídos</button>
                    <a href="{{ route('tasks.create') }}" style="border: none" class="btn"><i
                ...
                <div>
                    <div class=" m-3 d-flex align-items-center -content-center">
                        <div style="margin-right: 20px; display:flex; flex-direction:column;">
                            @if ($task->completed)
                                <button style="border: none" class="btn" wire:click="uncheck({{ $task }})"
                                    style="color: red; border:none;" title="Desmarcar como concluído">
                                    <i class="ti ti-checks mt-2"></i>
                                </button>
                            @else
                                <button style="border: none" class="btn" wire:click="check({{ $task }})"
                                    style="color: green; border:none;" title="Marcar como concluído">
                                    <i class="ti ti-check mt-2"></i>
                                </button>
                            @endif
                            <button style="border: none" class="btn" wire:click="delete({{ $task }})">
                    ...
                    <div>
                        ...
                        <p class="d-inline-flex gap-1">
                            @if (sizeof($task->subtasks) != 0)
                                <button style="border: none" class="btn" type="button" data-bs-toggle="collapse"
                            ...
                            <button style="border: none" type="button" class="btn" data-bs-toggle="modal"
                                data-bs-target="#task-id" data-bs-whatever="@mdo"> <i
                                    class="ti ti-plus"></i>Subtarefa</button>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <button style="border: none" type="button" class="btn-close"
                                    ...
                                    <div class="modal-footer">
                                        <button style="border: none" data-bs-dismiss="modal" type="submit"
